...
contract AsyncVault is IERC7540, SyncVault {
    ...
    function setFees1(uint16 _fees1) public onlyOwner {
        if (_fees1 > MAX_FEES) revert FeesTooHigh();
        fees1InBips = _fees1;
    }
    ...
    function setFees2(uint16 _fees2) public onlyOwner {
        if (_fees2 > MAX_FEES) revert FeesTooHigh();
        fees2InBips = _fees2;
    }
        ...
        )
    {
        ...
        settleValues = SettleValues({
            lastSavedBalance: _lastSavedBalance + _fees1 + _fees2,
            fees1: _fees1,
            fees2: _fees2,
        ...
        expectedAssetFromOwner = _fees1 + _fees2 + assetsToVault;
    }
